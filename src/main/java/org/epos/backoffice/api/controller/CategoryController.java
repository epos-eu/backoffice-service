...
public class CategoryController extends MetadataAbstractController<Category> implements ApiDocTag{
    ...
    @ResponseBody
    @Operation(summary = "create Category instance", description = "You can use this endpoint to create a Category instance (more information about which fields are required and how to use it are into the BackOffice repository documentation)")
    @ApiResponses(value = {
    ...
    @ResponseBody
    @Operation(summary = "update Category instance", description = "You can use this endpoint to update a Category instance (more information about which fields are required, who has the permission and how to use it are into the BackOffice repository documentation)")
    @ApiResponses(value = {
    ...
    @ResponseBody
    @Operation(summary = "delete Category instance", description = "You can use this endpoint to delete a Category instance (more information about which fields are required, who has the permission and how to use it are into the BackOffice repository documentation)")
    @ApiResponses(value = {
