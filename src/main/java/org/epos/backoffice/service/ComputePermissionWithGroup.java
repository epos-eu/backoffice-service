...
public class ComputePermissionWithGroup extends ComputePermissionAbstract {
    ...
    public ComputePermissionWithGroup(BackofficeOperationType op, GroupFilter groupFilter) {
        super(op);
    ...
    public boolean isAuthorized() {
        try {
            return trueMap.get(op.getUserRole()).get(op.getOperationType()).contains(op.getEntityType()) && groupFilter.isOk();
